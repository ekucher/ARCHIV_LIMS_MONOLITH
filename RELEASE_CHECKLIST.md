...
- PSScriptAnalyzer — не встановлено, не запускається; немає CI (аудит
  P0.1).
- Автоматичний secret scanning — немає; єдиний захист — ручний перегляд
  діфу (див. вище) і масковка в логах (`Protect-BRAVOLogSecret`, не
  перевірка сирців на витік).
...
- Restore drill (`RestoreVerified`) — не існує (аудит P0.5); `7z test` +
  SHA512 підтверджують цілісність архіву, не відновлюваність системи.
